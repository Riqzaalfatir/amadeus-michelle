    ...
    return (
        <section className='w-full bg-[repeating-linear-gradient(90deg,#E3CDB6_0px,#E3CDB6_3px,#F0E1D0_3px,#F0E1D0_12px)] py-[50px]'>
            ...
            >
                ...
                <motion.h2 className='text-[#2E497C] text-[24px] font-nephilm uppercase tracking-[1px]' variants={fadeUp}>
                    Pesan Pribadi
                </motion.h2>

                <motion.h4 className='text-[#C75376] text-[16px] font-breadley tracking-[1px]' variants={fadeUp}>
                ...
                <motion.input
                    type="text"
                    className='p-3 w-[321px] bg-white/60 rounded-md mt-[43px]'
                    variants={fadeUp}
                />

                {/* Pesan */}
                <motion.textarea
                    className='p-3 h-[240px] w-[321px] bg-white/60 rounded-md mt-[15px]'
                    variants={fadeUp}
                />

                <motion.p className='text-[#C75376] text-[16px] font-breadley mt-[28px] tracking-[1px] leading-none' variants={fadeUp}>
                    Tambah foto atau video?
                </motion.p>

                {/* Upload Media */}
                <motion.label className="mt-[12px] w-[321px] h-[37px] bg-white/60 rounded-md flex items-center justify-start cursor-pointer" variants={fadeUp}>
                    <div className="text-[#C75376] text-2xl leading-none pl-4">+</div>
                    <input type="file" accept="image/*,video/*" onChange={handleFileChange} className="hidden" />
                </motion.label>

                <motion.button className="bg-[#2E497C] py-2 px-10 text-white rounded-md text-[14px] font-breadley mt-[25px] tracking-[1px]" variants={scaleFade}>
                    Kirim Pesan
                </motion.button>

                <motion.div className="w-[321px] bg-[#E9D5C0] rounded-lg mt-[70px] pt-[33px] pb-[50px] flex flex-col gap-8" variants={fadeUp}>
