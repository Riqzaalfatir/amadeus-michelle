...
const container: Variants = {
  ...
  show: {
    transition: {
      staggerChildren: 0.6, // elemen muncul slow satu per satu
...
const DresscodeSection = () => {
    return (
        <section className='w-full bg-[#E9D5C0]'>
            ...
            >
                <motion.h2
                  className='text-[#2E497C] text-[24px] font-nephilm mb-[22px] tracking-[1px] leading-none'
                  variants={fadeUp}
                >
                  DRESSCODE
                </motion.h2>
                <motion.h4
                  className='text-[#C75376] text-[16px] font-breadley tracking-[1px]'
                  variants={fadeUp}
                >
