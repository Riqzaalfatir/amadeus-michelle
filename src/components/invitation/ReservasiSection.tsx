    ...
    return (
        <section className="w-full bg-[#F6EEE1] pt-[80px] pb-[50px]">
            <div className="max-w-7xl mx-auto px-4 text-center">
                ...
                {/* Description */}
                <p className="text-[#C75376] text-[16px] font-breadley pt-[11px]">
                ...
                <div className="flex justify-center gap-6 mt-[40px]">
                    <button className="bg-white text-[#E0A786] px-8 py-2 rounded-lg text-[14px] font-breadley shadow-sm">
                        Hadir
                    </button>
                ...
                {/* Help */}
                <p className="text-[#C75376] text-[16px] font-breadley uppercase pt-[35px]">
                    PERLU BANTUAN?
                </p>

                <button className=" bg-white text-[#E0A786] px-8 py-2 rounded-lg text-[14px] font-breadley shadow-sm mt-[15px]">
                    Hubungi Tim Provite
                </button>
