    ...
    <section className="w-full bg-[#F6EEE1] pt-[80px] pb-[50px]">
      ...
      >
        ...
        <motion.div className="flex justify-center gap-6 mt-[40px]" variants={fadeUp}>
          <a
            href="https://wa.me/6283102851438?text=Halo%20saya%20Guest%20Name%20%26%20Fam.%20Saya%20akan%20hadir%20di%20acara%20pernikahan%20Anda."
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className="bg-white text-[#E0A786] px-8 py-2 rounded-lg text-[14px] md:text-[18px] lg:text-[14px] font-breadley tracking-[1px] shadow-sm transition-all duration-300 ease-out hover:bg-[#E0A786] hover:text-white hover:shadow-lg hover:scale-105 active:scale-95">
              Hadir
            </button>
          </a>

          <a
            href="https://wa.me/6283102851438?text=Halo%20saya%20Guest%20Name%20%26%20Fam.%20Mohon%20maaf%20saya%20tidak%20dapat%20hadir%20di%20acara%20pernikahan%20Anda."
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className="bg-white text-[#E0A786] px-8 py-2 rounded-lg text-[14px] md:text-[18px] lg:text-[14px] font-breadley tracking-[1px] shadow-sm transition-all duration-300 ease-out hover:bg-[#E0A786] hover:text-white hover:shadow-lg hover:scale-105 active:scale-95">
        ...
        <motion.a
          href="https://wa.me/6283102851438?text=Halo%20Tim%20Provite,%20saya%20ingin%20bertanya%20mengenai%20undangan%20pernikahan."
          target="_blank"
          rel="noopener noreferrer"
          variants={fadeUp}
        >
          <button
            className="bg-white text-[#E0A786] px-8 py-2 rounded-lg text-[14px] md:text-[18px] lg:text-[14px] font-breadley mt-[15px] tracking-[1px] shadow-sm transition-all duration-300 ease-out hover:bg-[#E0A786] hover:text-white hover:shadow-lg hover:scale-105 active:scale-95"
          >
            Hubungi Tim Provite
          </button>
        </motion.a>
